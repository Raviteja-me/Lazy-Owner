    ...
    export default function HomePage() {
      ...
      return (
        <div className="min-h-screen bg-gray-900 text-white font-manrope">
              ...
              <div className="flex justify-between h-16">
                <div className="flex items-center">
                  <Link to="/" className="flex items-center">
                    <span className="text-3xl font-bold text-purple-500">L</span>
                    <span className="text-2xl font-bold text-white">azyOwner</span>
                  </Link>
                </div>
            ...
            <div className="container relative mx-auto z-10">
              <div className="flex flex-wrap">
                <div className="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                  {/* Logo and Headline Container */}
                  <div className="flex flex-col items-center justify-center">
                    <img src={Image} alt="LazyOwner Logo" className="h-38 mb-8" /> {/* Changed mb-16 to mb-8 */}
          ...
          {/* Remove entire Featured Listings Section and go directly to How It Works */}
          <section className="py-20">
            <div className="container mx-auto px-4">
              <div className="flex flex-wrap justify-center text-center mb-16">
                <div className="w-full lg:w-6/12 px-4">
